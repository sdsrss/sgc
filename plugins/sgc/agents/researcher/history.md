...
description: "Mines git history and .sgc/solutions/ for prior art relevant to the current task. Surfaces past solutions, patterns, and warnings. Dispatched by /plan for L2+ tasks."
---
...
- Access to `.sgc/solutions/` directory
...
Search `.sgc/solutions/` using the native content-search tool (Grep). Run multiple searches in parallel, case-insensitive, returning only matching file paths:
...
- If `.sgc/solutions/` does not exist, report this and focus on git history alone.
