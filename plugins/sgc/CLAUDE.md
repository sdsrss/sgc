...
## Implementation Status (v1.31.8 — GS-N arc 7/7 + Tier-1 sp absorb + L2 reviewer cluster wired + four-化 metrics + CLI UX hardening + QA/ship gate integrity + SGC_STATE_ROOT honored everywhere + LLM planner resilience)
