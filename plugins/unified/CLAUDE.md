...
All persistent state lives under `.unified/` in the project root. Four directories, each with single ownership:
...
`unified:category:agent-name` (e.g., `unified:reviewer:correctness`)
